...
namespace kbradu
{
    public static class TensorFloatExtensions
    {
        ...
        public static int[] Shape4D(this TensorFloat tensor)
        {
        ...
        public static TensorFloat Zeros(params int[] shape)
        {
            return TensorFloat.AllocZeros(new TensorShape(shape)); 
        }
        public static TensorFloat Random01(params int[] shape)
        {
            ...
            return new TensorFloat(new TensorShape(shape), nums);
        }
        public static TensorFloat FromTexture(Texture2D texture, ImageShape retain_in_format, OriginLike read_like, int channels = 3, bool multithread = true)
        {
        ...
        private static TensorFloat HWCFromTexture(Texture2D texture, OriginLike read_like, int channels = 3, bool multithread = true)
        {
            if (texture == null)
            {
        ...
        /// <returns></returns>
        /// <exception cref="System.NotImplementedException"></exception>
        private static TensorFloat CHWFromTexture(Texture2D texture, OriginLike read_like, int channels = 3, bool multithread = true)
        {
            if (texture == null)
            {
                UnityEngine.Debug.LogError("Texture is null. Cannot convert to tensor.");
        ...
        public static TensorFloat Rotate(this TensorFloat image, float angleDegrees, bool self_dispose = true)
        {
            if (image == null)
            {
        ...
        /// </summary>
        /// <param name="image"></param>
        public static TensorFloat AffineTransform(this TensorFloat image, float weight = 1, float bias = 0, bool multithread = true, bool self_dispose = true)
        {
            if (image == null)
            {
            ...
            TensorFloat affined = TensorFloat.AllocZeros(image.shape);
        ...
        /// </summary>
        /// <param name="image"></param>
        public static TensorFloat Resize(this TensorFloat image, int newWidth, int newHeight, bool multithread = true, bool self_dispose = true)
        {
            if (image == null)
            {
        ...
        /// </summary>
        /// <param name="image"></param>
        public static TensorFloat CenterCrop(this TensorFloat image, bool multithread = true, bool self_dispose = true)
        {
            if (image == null)
            {
        ...
        /// </summary>
        /// <param name="image"></param>
        public static TensorFloat ToGrayscale(this TensorFloat image, bool average = false, bool self_dispose = true)
        {
            if (image == null)
            {
        ...
        /// </summary>
        /// <param name="image"></param>
        public static TensorFloat FlipHorizontally(this TensorFloat image, bool self_dispose = true)
        {
            int[] shape = image.Shape4D();
        ...
        /// </summary>
        /// <param name="image"></param>
        public static TensorFloat FlipVertically(this TensorFloat image, bool self_dispose = true)
        {
            int[] shape = image.Shape4D();
        ...
        /// </summary>
        /// <param name="image"></param>
        public static TensorFloat Rescale(this TensorFloat image, float scale, bool self_dispose = true)
        {
        ...
        public static TensorFloat HWC2CHW(this TensorFloat image, bool multithread = true, bool self_dispose = true)
        {
            if (image == null)
            {
                UnityEngine.Debug.LogError("Tensor is null. Cannot perform center crop.");
        ...
        public static TensorFloat CHW2HWC(this TensorFloat image, bool multithread = true, bool self_dispose = true)
        {
            if (image == null)
            {
                UnityEngine.Debug.LogError("Tensor is null. Cannot perform center crop.");
        ...
        public static void AffineTransform_(this TensorFloat image, float weight = 1, float bias = 0, bool multithread = true)
        {
            if (image == null)
            {
                UnityEngine.Debug.LogError("Tensor is null. Cannot perform affine transform.");
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentException"></exception>
        public static Texture2D ToTexture(this TensorFloat image, ImageShape tensor_format, bool multithread = true)
        {
        ...
        private static Texture2D FromHWC2Texture(this TensorFloat tensorHWC, bool multithread = true)
        {
            if (tensorHWC == null)
            {
        ...
        private static Texture2D FromCHW2Texture(this TensorFloat tensorCHW, bool multithread = true)
        {
            if (tensorCHW == null)
            {
                UnityEngine.Debug.LogError("Tensor is null. Cannot convert to texture.");
        ...
        public static string ToFullString(this TensorFloat image)
        {
        ...
        /// <returns></returns>
        public static bool Equals(this TensorFloat tensor, TensorFloat other)
        {
            if (tensor.shape != other.shape)
                return false;
            if (tensor.ToReadOnlyArray() != other.ToReadOnlyArray())
                return false;
        ...
        /// <param name="tensor"></param>
        /// <returns></returns>
        public static TensorFloat Clone(this TensorFloat tensor)
        {
